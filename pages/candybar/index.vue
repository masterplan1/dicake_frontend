  ...
  <section class="products">
    <div class="products__wrapper candybar__wrapper">
      ...
      <div class="products__sub_title-header">
          ...
          <img src="images/svg/candy_bar-left-syn.svg" alt="" class="products__sub-title-img">
          <img src="images/svg/candy_bar-right-syn.svg" alt="" class="products__sub-title-img">
      </div>
...
export default {
  data(){
    return{
      title: 'Замовити Candybar, кейпопси, трайфли та інші солодощі в кондитерській «Трюфель»'
    }
  },
  head() {
    return {
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Сторити кендібар, замовити капкейки, кейпопси, трайфли та інші солодощі в кондитерській «Трюфель»! Доставка в Обухів, Українку та Київ'
        }
      ]
    }
  }
...
.products__candybar-order-desc{
    background: url(static/images/svg/candy_bar-red-circule.svg) no-repeat left center;
    padding-left: 30px;
}
.candybar-cards{
    margin-bottom: 164px;
...
/* .cards-cupcake::after{
    ...
    left: -244px;
    bottom: 0;
    background: url(static/images/svg/candy_bar-cupcake-01.svg) no-repeat left center;
    width: 215px;
    height: 292px;
} */
...
/* .candybar__toppers-content::after{
    ...
    left: -244px;
    top: 0;
    background: url(static/images/svg/candy_bar-cupcake-03.svg) no-repeat left center;
    width: 220px;
    height: 292px;
} */
